	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				...
				%>
				<div class="alert alert-danger" id="danger">Dietitian deleted
					successfully.</div>
				<%
					}
				%>
									...
									<tr class="default">
										...
										<td><a
											href="ManageDietition?did=<%=resultset.getInt(1)%>"><button
													...
													onClick="return confirm('Are you sure, you want to Activate Account?');">Activate
													Dietitian</button></a></td>
										<%
											}
										%>
										<td><a
											...
											class="btn btn-info"
											onclick="return confirm('Are you sure you want to delete this Dietitian?');">Delete</a></td>
									</tr>
								</tbody>
								<%
									}
